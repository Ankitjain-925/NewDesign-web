...
class Index extends Component {
    ...
    render() {
      ...
      switch (this.props.stateLanguageType) {
        ...
        if (stateLoginValueAim.user === 'undefined' || stateLoginValueAim.token === 450 || stateLoginValueAim.token === 'undefined' || stateLoginValueAim.user.type !== 'insurance' || !this.props.verifyCode || !this.props.verifyCode.code) {
            return (<Redirect to={'/'} />);
            }   
        return (
                                ...
                                <Grid item xs={12} md={10}>
                                    {this.props.Emergencysetget.p_id !== null &&
                                        <Grid className="emrgncyDataUpr">
                                            ...
                                            <EmergencyCall byUser="insurance" anotherPatient={this.anotherPatient} />
                                    ...
                                    <Modal
                                        ...
                                        <Grid className="paraBoxCntnt">
                                            ...
                                            {this.state.error_msg && <div className="err_message">{patient_profile_not_crrect}</div>}

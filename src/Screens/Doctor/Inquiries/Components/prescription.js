                                    ...
                                    <Td className="presEditDot scndOptionIner">
                                        <a className="openScndhrf">
                                            ...
                                            <ul>
                                                ...
                                                {(data.status == 'free'||data.status === 'pending') && <li onClick={() => { this.handleOpenPrescp(data) }}><a><img src={require('../../../../assets/images/edit.svg')} alt="" title="" />Accept</a></li>}
                                                {(data.status == 'free'||data.status === 'pending') && <li onClick={() => { this.updatePrescription('decline', data._id) }}><a><img src={require('../../../../assets/images/plus.png')} alt="" title="" />Reject</a></li>}

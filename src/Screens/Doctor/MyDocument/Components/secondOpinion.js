...
class Index extends Component {
    ...
    render() {
        ...
        let translate = getLanguage(this.props.stateLanguageType)
        let { capab_Doctors, see_details, status, sent, on, sent_on, Case, Patient, what_ur_profession, accept, decline, remove, Pending, request, edit, not_mentioned, Rejected, Answered, Cancelled, req_updated_successfully, sick_cert, my_doc, New, inquiry,

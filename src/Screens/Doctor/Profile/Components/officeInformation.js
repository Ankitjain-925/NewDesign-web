...
class Index extends Component {
  ...
  render() {
    ...
    let {
      offc_info,
      this_is_what_patient_see_arrenging_appointment,
      we_offer,
      latest_info,
      date,
      time,
      ...
      updated,
      save_change,
      the_info_isnt_update_succ,
      the_info_update_succefully,
    } = translate;
    const { UpDataDetails } = this.state;
    return (
      <div>
        ...
        {this.state.PassDone && (
          <div className="success_message">{the_info_update_succefully}</div>
        )}
        {this.state.PassFail && (
          <div className="err_message">{the_info_isnt_update_succ}</div>
        )}
            ...
            <Grid item className="officInfo profileInfoIner">
              ...
              <Grid>
                <input
                  ...
                  value={
                    this.state.UpDataDetails.weoffer_text
                      ? this.state.UpDataDetails.weoffer_text
                      : ""
                  }
                />
            ...
            <Grid className="latstInfo">
              ...
              <Grid>
                <ReactQuill
                  name="latest_info"
                  value={
                    this.state.UpDataDetails.latest_info
                      ? UpDataDetails.latest_info
                      : ""
                  }

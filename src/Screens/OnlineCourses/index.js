                                                            ...
                                                            <Grid className="add_wishList">
                                                                <Grid container direction="row" alignItems="center">
                                                                    <Grid item xs={12} md={9}>
                                                                        <Grid className="nwCoursCrt"><a>Add to cart</a></Grid>
                                                                    </Grid>
                                                                    <Grid item xs={12} md={3}>
                                                        ...
                                                        <Modal
                                                            ...
                                                            <div className="wishListCntnt">
                                                                ...
                                                                <Grid className="wshCorList">
                                                                    <Grid className="wshCorListLbl"><label>What is Diabetes?</label></Grid>
                                                                    <Grid className="wshCorListInr">
                                                                        ...
                                                                        <Grid className="nwWshCrtUpr">
                                                                            <Grid container direction="row" alignItems="center">
                                                                                <Grid item xs={12} md={9}>
                                                                                    <Grid className="nwWshCrt"><a>Add to cart</a></Grid>
                                                                                </Grid>
                                                                                <Grid item xs={12} md={3}>

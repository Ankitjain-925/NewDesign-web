                                ...
                                <Modal
                                    ...
                                    <div className="alowLocAces">
                                        <div className="accessCourse">
                                            ...
                                            <div className="showSpcial"><p><img src={require('../../../assets/images/location.png')} alt="" title="" />{we_r_showing_speciality} “{this.state.MycurrentLocationName}” in {this.state.searchDetails.radius ? this.state.searchDetails.radius : '10'} {km_range}</p></div>
                                        </div>

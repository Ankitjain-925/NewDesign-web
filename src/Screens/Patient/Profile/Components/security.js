...
class Index extends Component {
    ...
    render() {
        ...
        let { Change, password, is, we_use_authy, supportive_text, Passwordisnotvalid, Current, confirm_password, new_password, two_fac_auth, password_changed, new_and_confirm_pass_not_same, enabled, disabled, current_pass_not_match, plz_fill_fields, Register_characters,
            Disable, Enable, change_password, Register_Passwordshould, Register_letter, Register_number, Register_special } = translate;

              ...
              <Grid className="profileInfoDate">
                <Grid container direction="row" alignItems="center" spacing={2}>
                  ...
                  <Grid item xs={12} md={8}>
                    ...
                    <Grid>
                      <a
                        onClick={() => EntryValueName('male', 'sex', this)}
                        className={
                      ...
                      <a
                        onClick={() => EntryValueName('female', 'sex', this)}
                        className={
                          this.state.UpDataDetails.sex &&
                      ...
                      <a
                        onClick={() => EntryValueName('other', 'sex', this)}
                        className={
                          this.state.UpDataDetails.sex &&
              ...
              <Grid className="profileInfoIner">
                <Grid container direction="row" alignItems="center" spacing={2}>
                  <Grid item xs={12} md={8}>
                    ...
                    <Grid>
                      {updateFLAG(this.state.UpDataDetails.phone) &&
                        updateFLAG(this.state.UpDataDetails.phone) !== '' && (
                          <ReactFlagsSelect
                            searchable={true}
                      ...
                      <input
                        ...
                        value={
                          this.state.UpDataDetails.phone &&
                          updateMOBILE(this.state.UpDataDetails.phone)
                        }
                      />
                    </Grid>
                  </Grid>
              ...
              <Grid className="profileInfoIner">
                <Grid container direction="row" alignItems="center" spacing={2}>
                  <Grid item xs={12} md={8}>
                    ...
                    <Grid>
                      {updateFLAG(this.state.UpDataDetails.mobile) &&
                        updateFLAG(this.state.UpDataDetails.mobile) !== '' && (
                          <ReactFlagsSelect
                            searchable={true}
                      ...
                      <input
                        ...
                        value={
                          this.state.UpDataDetails.mobile &&
                          updateMOBILE(this.state.UpDataDetails.mobile)
                        }
                      />
                    </Grid>
                  </Grid>
                  ...
                  <Grid item xs={12} md={4}>
                    ...
                    <Grid>
                      <Select
                        ...
                        name="bloodgroup"
                        onChange={(e) => {
                          EntryValueName(e, 'blood_group', this);
                        }}
          ...
          <Grid className="emrgncyFrmInpt">
            ...
            <Grid>
              ...
              {updateFLAG(this.state.contact_partner.number) &&
                updateFLAG(this.state.contact_partner.number) !== '' && (
                  <ReactFlagsSelect
                    ...
                    placeholder={country_code}
                    onSelect={(e) => {
                      updateflags(e, 'flag_emergency_number', this);
                    }}
              ...
              <input
                ...
                value={
                  this.state.contact_partner.number &&
                  updateMOBILE(this.state.contact_partner.number)
                }
              />
            </Grid>
          </Grid>
              ...
              <Grid className="editPinform">
                <Grid className="editField">
                  {this.state.insurnanceAdded && (
                    <div className="success_message">{insurance_added}</div>
                  )}
                  {this.state.insu1 && (
                    <div className="err_message">{InsurancecompanyError}</div>
                  )}
                  <label>
                ...
                <Grid className="editField">
                  ...
                  <ul
                    ...
                    style={{
                      height:
                        companyList && companyList.length > 0 ? '150px' : '',
                    }}
                  >
                    {companyList}
                  </ul>
                    ...
                    <td className="presEditDot scndOptionIner pivoted">
                      <a className="openScndhrf">
                        ...
                        <ul>
                          ...
                          <li>
                            <a onClick={() => removeInsurance(i, insu, this)}>
                              <img
                                src={require('assets/images/close-search.svg')}
                                alt=""
                                title=""
                ...
                <Grid className="editField">
                  ...
                  <Grid className="cntryDropTop">
                    <Select
                      ...
                      onChange={(event) =>
                        updatesinsurancesCountry(editIndex, event, this)
                      }
                      options={this.state.selectCountry}
                      placeholder=""
                      isSearchable={true}
                ...
                <Grid className="editField">
                  ...
                  <Grid>
                    <input
                      ...
                      name="insurance"
                      onChange={(event) =>
                        updatesinsurances(editIndex, event, this)
                      }
                    />
                  </Grid>
                  <ul

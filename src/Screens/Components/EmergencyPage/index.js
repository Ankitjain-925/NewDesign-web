        ...
        this.setState(
          ...
          () => {
            ...
            state1["relation"] =
              ...
              this.state.personalinfo.emergency_relation;
            ...
            if (
              ...
              this.state.family_doc[0] &&
              this.state.family_doc[0].image
            ) {
                ...
                <Grid className="docCntctMain">
                  ...
                  {!this.state.EditFamily ? (
                    ...
                    <DoctorSection
                      ...
                      EditFamilyDoc={this.EditFamilyDoc}
                      comesFrom="emergency"
                    />
                  )}
                </Grid>
                      ...
                      <Grid className="emrgncyFrmInpt">
                        ...
                        <Grid>
                          {/* <PhoneInput
                                            ...
                                            /> */}
                          {this.updateFLAG(this.state.contact_partner.number) &&
                            this.updateFLAG(
                              this.state.contact_partner.number
                            ) !== "" && (
                              <ReactFlagsSelect
                ...
                <Grid className="docCntctMain">
                  ...
                  <Grid className="jlyMorr">
                    {!this.state.editDonar ? (
                      ...
                      <OrganSection
                        EditOrganDonar={this.EditOrganDonar}

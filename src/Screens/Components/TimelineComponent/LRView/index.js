...
class Index extends Component {
    ...
    render() {
        ...
        let { lab_result, visibility, Download, Delete, visible, img_file, details, hide, title, show, VeiwGraph, date, time, upr_limit, lwr_limit, lab_parameter, first_day_visit, always, edit, date_of_death, date_of_dieses_patient, dob, day_doc_visit, gender_of_relatives, relation_of_relative, Change, speciality, hosp_id, hosp_name, doc_id, traveled, slct_ICD_serch_code, when, to, allergy, enter_code_serch_by_keyword, dignose, of, until, archive, rr_systolic, attachments, time_measure, date_measure,

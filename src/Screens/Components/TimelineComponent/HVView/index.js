...
class Index extends Component {
  ...
  componentDidUpdate = (prevProps) => {
    ...
    render() {
        ...
        let { hosp_visit, doc_id, hosp_name, hosp_id, last_visit_day, speciality, dob, visible, pain_areas, Change, show, hide, until, archive, rr_systolic, attachments, time_measure, date_measure,

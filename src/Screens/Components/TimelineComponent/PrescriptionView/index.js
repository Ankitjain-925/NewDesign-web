...
class Index extends Component {
    ...
    render() {
        ...
        let { diagnosis, depression, mild_depresive_episode, travel, upr_limit, unit, allergy, multiple_lesions_again_suggest, lwr_limit, on, pill_taken, INR, prescribed, quik_value, save_entry, on_demand, visible, to_be_consume, pain_areas, Change, show, hide, until, archive, attachments, time_measure, date_measure,
            medication, diagnosed, by, edit, Delete, enter_a_sbstnce, atc_code, marcumer_pass, trade_name, first_visit_day, pain_type, de_archive, ur_trade_name, always, feeling, date, time } = translate
        return (
                            ...
                            <Collapsible trigger="Details" open="true">
                                <Grid className="detailCntnt">
                                    <Grid container direction="row">
                                        ...
                                        <Grid item xs={12} md={6} className="diagnoBy">
                                            <Grid container direction="row">
                                                <Grid item xs={5} md={5}><label>{diagnosis} {on}</label></Grid>

...
class Index extends Component {
    ...
    render() {
        ...
        let {visible, feeling, vaccination,DocAuthName,VaccinationCharge, show,Daydate,PositiveSARS,vaccination_charge, SARSCoV_2_TEST,date_of_vaccination, time_of_vaccination, date, VaccinationTrial, time, hide, until, archive, temparture, pain_type, pain_quality,
            edit, Delete, RR_diastolic, heart_rate, always, Download, img_files, notes, details,Date_of_event,
            Newdiagnoses, Newmedication, Newallergies,Newinfections, Digestion,Diaryentry,Newdoctorvisits,Newhospitalizations, Change, Location, visibility, de_archive, covid_diary, pain_areas, not_mentioned, condition_pain } = translate
        return (
                    ...
                    <Grid className="descpInerRght">
                        <Grid container direction="row" className="addSpc">
                            <Grid item xs={12} md={6}>
                                <Grid className="conPainImg">
                                    <a className="conPainNote"><img src={require('../../../../assets/images/condition-diagnosis-family-anamnesis-diary.svg')} alt="" title="" /><span>{VaccinationTrial}</span> </a>
                                </Grid>
                            </Grid>
                            <Grid item xs={12} md={6}>
                        ...
                        <Grid container direction="row" className="addSpc conPainGraph">
                            ...
                            <Grid item xs={12} md={7}>
                                <Grid className="conPainRght">
                                    ...
                                    <Grid className="condIntencty">
                                        <Grid><label>{temparture}</label></Grid>
                                        <p>{item.temprature && item.temprature} {item.temprature_type && item.temprature_type.label}</p>
                                    </Grid>
                                </Grid>
                            </Grid>
                            <Grid className="clear"></Grid>
                            ...
                            <Collapsible trigger={details} open="true">
                                ...
                                <Grid container direction="row">
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                                <Grid item xs={5} md={5}><label>{DocAuthName}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.doctor_name && item.doctor_name}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                    ...
                                    <Grid container direction="row">
                                        ...
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                            <Grid item xs={5} md={5}><label>{VaccinationCharge}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.vaccination_charge && item.vaccination_charge}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid className="clear"></Grid>
                                    ...
                                    <Grid container direction="row">
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                                ...
                                                <Grid item xs={7} md={7}><span>{item.date_of_vaccination && getDate(item.date_of_vaccination , this.state.date_format)}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                            <Grid item xs={5} md={5}><label>{time_of_vaccination}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.time_of_vaccination && getDate(item.time_of_vaccination , this.state.date_format)}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid className="clear"></Grid>
                                    ...
                                    <Grid container direction="row">
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                                <Grid item xs={5} md={5}><label>{Newdiagnoses}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.new_diagnoses && item.new_diagnoses}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                            <Grid item xs={5} md={5}><label>{Newmedication}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.new_medication && item.new_medication}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid className="clear"></Grid>
                                    ...
                                    <Grid container direction="row">
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                                <Grid item xs={5} md={5}><label>{Newallergies}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.new_allergies && item.new_allergies}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                            <Grid item xs={5} md={5}><label>{Digestion}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.digestion && item.digestion}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid className="clear"></Grid>
                                    ...
                                    <Grid container direction="row">
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                                <Grid item xs={5} md={5}><label>{Diaryentry}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.diary_entry && item.diary_entry}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                            <Grid item xs={5} md={5}><label>{Newdoctorvisits}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.new_doctor_visits && item.new_doctor_visits}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid className="clear"></Grid>
                                    ...
                                    <Grid container direction="row">
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                                <Grid item xs={5} md={5}><label>{Newhospitalizations}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.new_hospitalizations && item.new_hospitalizations}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid item xs={12} md={6} className="painTypeBy">
                                            <Grid container direction="row">
                                            <Grid item xs={5} md={5}><label>{Newinfections}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.new_infections && item.new_infections}</span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                        <Grid className="clear"></Grid>
                        ...
                        <Grid className="addSpc detailMark">
                            <Collapsible trigger={SARSCoV_2_TEST} open="true">
                                <FileViews images={this.state.images} attachfile={item.SARS} />
                            </Collapsible>
                        </Grid>
                        <Grid className="addSpc detailMark">
                            <Collapsible trigger={PositiveSARS} open="true">
                                <FileViews images={this.state.images} attachfile={item.Positive_SARS} />
                            </Collapsible>
                        </Grid>
                        <Grid className="addSpc detailMark">

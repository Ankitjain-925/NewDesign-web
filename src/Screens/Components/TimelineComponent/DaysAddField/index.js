    ...
    return (
      <div>
        <Grid className="rrSysto">
            ...
            <Grid>
                <MMHG name="day_after"  onChange={(e)=> this.onFieldChange(e, 0)} />   
            ...
            this.state.findingArr.map((itm, index) => (
                index == 0 ? <Grid>
                       <MMHG name="day_after"  onChange={(e)=> this.onFieldChange(e, 0)} value={itm && itm}/>   
                    <Grid className="consumeAt"><p onClick={this.onAddFiled}>+ {addtextentry}</p></Grid>
                    </Grid>
                : 
                <Grid>
                     <MMHG name="day_after"  onChange={(e)=> this.onFieldChange(e, index)} value={itm && itm}/>  

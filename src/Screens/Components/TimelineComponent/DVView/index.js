...
class Index extends Component {
    ...
    render() {
        ...
        let { visibility, Download, Delete, visible, hide, img_files,  details, show, doc_visit, always, edit, day_doc_visit, Change, speciality, traveled, slct_ICD_serch_code, when, to, allergy, enter_code_serch_by_keyword, dignose, of, until, archive, rr_systolic, attachments, time_measure, date_measure,
                ...
                <Grid item xs={12} md={10}>
                    <Grid className="descpInerRght descpInerPurple">
                        ...
                        <Grid container direction="row" className="addSpc">
                            <Grid item xs={12} md={6}>
                                <Grid className="blodPrsurImg purpleSpan">
                                    <a className="diryNote"><img src={require('../../../../assets/images/doctor-appointments.svg')} alt="" title="" />
                                        <span>{doc_visit}</span>
                                    </a>
                                </Grid>
                            </Grid>
                        ...
                        <Grid className="bp_hg addSpc">
                            <label>{item.doctor_name && item.doctor_name} <span></span></label>
                            {/* <p>Normal</p> */}
                        </Grid>
                                ...
                                <Grid className="detailCntnt">
                                    <Grid container direction="row">
                                        <Grid item xs={12} md={6} className="bloodPreBy">
                                            <Grid container direction="row">
                                                <Grid item xs={5} md={5}><label>{doc_name}</label></Grid>
                                        ...
                                        <Grid item xs={12} md={6} className="bloodPreBy">
                                            <Grid container direction="row">
                                                <Grid item xs={5} md={5}><label>{day_doc_visit}</label></Grid>
                                                <Grid item xs={7} md={7}><span>{item.date_doctor_visit && getDate(item.date_doctor_visit, this.state.date_format)} </span></Grid>
                                                <Grid className="clear"></Grid>
                                            </Grid>
                                        </Grid>
                                    </Grid>

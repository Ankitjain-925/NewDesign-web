                            ...
                            (
                              (this.state.personalinfo.weight_bmi[
                                ...
                                (this.state.personalinfo.weight_bmi[
                                  ...
                                  this.state.personalinfo.weight_bmi[
                                    this.state.personalinfo.weight_bmi.length -
                                      1
                                  ].height)) *
                              10000
                            ).toFixed(2)}{" "}
                                  ...
                                  <li>
                                    <a
                                      onClick={() =>
                                        this.props.EidtOption(
                                          this.state.Pancreaticlipase[
                                            this.state.Pancreaticlipase.length -
                                              1
                                          ].type,
                                          this.state.Pancreaticlipase[
                                            this.state.Pancreaticlipase.length -

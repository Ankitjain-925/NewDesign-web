...
class Index extends Component {
    ...
    render() {
      ...
      switch (this.props.stateLanguageType) {
        ...
        let {  selct_pain_area,vaccination, Newdiagnoses, Newmedication, Newallergies,Newinfections, Digestion,Diaryentry,Newdoctorvisits,Newhospitalizations, attachments,Daydate, DocAuthName, VaccinationCharge, PositiveSARS,Chargenumberpicture, date_of_vaccination, time_of_vaccination, SARSCoV_2_TEST,  Problem, notes, pain_type, save_entry, pain_quality }= translate
                ...
                {!this.props.visibility && <Grid className="cnfrmDiaMain">
                    ...
                    <Grid className="fillDia">
                        <Grid className="rrSysto">
                            ...
                            <DateFormat name="date_of_vaccination" value={this.state.updateTrack.date_of_vaccination ? new Date(this.state.updateTrack.date_of_vaccination) : new Date()} date_format={this.state.date_format} onChange={(e) => this.updateEntryState1(e, 'date_of_vaccination')} />
                        </Grid>
                    </Grid>
                    <Grid className="fillDia">
                        <Grid className="rrSysto">
                            <Grid><label>{time_of_vaccination}</label></Grid>
                    ...
                    <Grid className="fillDia">
                        <MMHG name="new_diagnoses" label={Newdiagnoses} onChange={(e) => this.props.updateEntryState(e)} value={this.state.updateTrack.new_diagnoses} />
                    </Grid>
                    <Grid className="fillDia">
                        <MMHG name="new_medication" label={Newmedication} onChange={(e) => this.props.updateEntryState(e)} value={this.state.updateTrack.new_medication} />
                    </Grid>
                    <Grid className="fillDia">
                        <MMHG name="new_allergies" label={Newallergies} onChange={(e) => this.props.updateEntryState(e)} value={this.state.updateTrack.new_allergies} />
                    </Grid>
                    <Grid className="fillDia">
                        <MMHG name="digestion" label={Digestion} onChange={(e) => this.props.updateEntryState(e)} value={this.state.updateTrack.digestion} />
                    </Grid>
                    <Grid className="fillDia">
                        <MMHG name="diary_entry" label={Diaryentry} onChange={(e) => this.props.updateEntryState(e)} value={this.state.updateTrack.diary_entry} />
                    </Grid>
                    <Grid className="fillDia">
                        <MMHG name="new_doctor_visits" label={Newdoctorvisits} onChange={(e) => this.props.updateEntryState(e)} value={this.state.updateTrack.new_doctor_visits} />
                    </Grid>
                    <Grid className="fillDia">
                        <MMHG name="new_hospitalizations" label={Newhospitalizations} onChange={(e) => this.props.updateEntryState(e)} value={this.state.updateTrack.new_hospitalizations} />
                    </Grid>
                    <Grid className="fillDia">
                        <MMHG name="new_infections" label={Newinfections} onChange={(e) => this.props.updateEntryState(e)} value={this.state.updateTrack.new_infections} />
                    </Grid>
                    <Grid className="attchForms attchImg">

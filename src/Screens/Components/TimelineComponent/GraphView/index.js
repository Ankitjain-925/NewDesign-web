                  ...
                  >
                    ...
                    <Grid>
                      <span>
                        ...
                        {this.state.Creatinine[this.state.Creatinine.length - 1]
                          .unit &&
                          this.state.Creatinine[
                            this.state.Creatinine.length - 1
                          ].unit.label}
                    ...
                    <Grid>
                      <span>
                        {this.state.AST &&
                          ...
                          this.state.AST[this.state.AST.length - 1] &&
                          this.state.AST[this.state.AST.length - 1].value}{" "}
                        {this.state.AST[this.state.AST.length - 1].unit &&
                          this.state.AST[this.state.AST.length - 1].unit.label}
                      </span>
                    </Grid>
                    <p>
                      {getDate(
                        this.state.AST[this.state.AST.length - 1].datetime_on,
                        this.state.date_format
                      )}
                      ,{" "}
                      {getTime(
                    ...
                    <Grid>
                      <span>
                        {this.state.GGT &&
                          ...
                          this.state.GGT[this.state.GGT.length - 1] &&
                          this.state.GGT[this.state.GGT.length - 1].value}{" "}
                        {this.state.GGT[this.state.GGT.length - 1].unit &&
                          this.state.GGT[this.state.GGT.length - 1].unit.label}
                      </span>
                    </Grid>
                    <p>
                      {getDate(
                        this.state.GGT[this.state.GGT.length - 1].datetime_on,
                        this.state.date_format
                      )}
                      ,{" "}
                      {getTime(
                    ...
                    <Grid>
                      <span>
                        {this.state.Sodium &&
                          ...
                          this.state.Sodium[this.state.Sodium.length - 1] &&
                          this.state.Sodium[this.state.Sodium.length - 1]
                            .value}{" "}
                        {this.state.Sodium[this.state.Sodium.length - 1].unit &&
                          this.state.Sodium[this.state.Sodium.length - 1].unit
                            .label}
                      </span>
                    </Grid>
                  ...
                  >
                    ...
                    <Grid>
                      <span>
                        ...
                        {this.state.Leucocytes[this.state.Leucocytes.length - 1]
                          .unit &&
                          this.state.Leucocytes[
                            this.state.Leucocytes.length - 1
                          ].unit.label}
                    ...
                    <Grid>
                      <span>
                        {this.state.ALT &&
                          ...
                          this.state.ALT[this.state.ALT.length - 1] &&
                          this.state.ALT[this.state.ALT.length - 1].value}{" "}
                        {this.state.ALT[this.state.ALT.length - 1].unit &&
                          this.state.ALT[this.state.ALT.length - 1].unit.label}
                      </span>
                    </Grid>
                    <p>
                      {getDate(
                        this.state.ALT[this.state.ALT.length - 1].datetime_on,
                        this.state.date_format
                      )}
                      ,{" "}
                      {getTime(

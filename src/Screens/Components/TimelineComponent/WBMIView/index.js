...
class Index extends Component {
  ...
  componentDidUpdate = (prevProps) => {
    ...
    render() {
        ...
        let { visible, archive, edit, Change, Delete, visibility, cmplt_ur_profile, blood, picture, add_profile, BMI, height, weight, weight_bmi, show, hide, until, pain_type, de_archive, ur_trade_name, always, feeling, date, time } = translate

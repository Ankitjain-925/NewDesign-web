...
class PointPain extends Component {
    ...
    saveUserData() {
        ...
        axios.put(sitedata.data.path + '/UserProfile/Users/updateImage', {
            ...
            axios.put('https://api-eu.cometchat.io/v2.0/users/' + this.state.personalinfo.info.profile_id.toLowerCase(), {
        ...
        return (
            <Grid className="profileDescp">
                ...
                <Grid className="profileName">
                    ...
                    {this.state.user.birthday && this.state.user.birthday !== '' ? <p>{getDate(this.state.user.birthday, this.props.settings.setting.date_format)} </p> : <p onClick={this.props.MoveProfile}>{cmplt_ur_profile}</p>}

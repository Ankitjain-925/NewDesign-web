...
class Index extends Component {
    ...
    render() {
        ...
        let { secnd_openion, visibility, Download, quik_value,  Date_of_event,details, Explanation, img_files,lwr_limit, upr_limit, pill_taken, Delete, visible, hide, title, show, first_day_visit, always, edit, date_of_death, date_of_dieses_patient, dob, day_doc_visit, gender_of_relatives, relation_of_relative, Change, speciality, hosp_id, hosp_name, doc_id, traveled, slct_ICD_serch_code, when, to, allergy, enter_code_serch_by_keyword, dignose, of, until, archive, rr_systolic, attachments, time_measure, date_measure,
                ...
                <Grid item xs={12} md={10}>
                    <Grid className="descpInerRght descpInerPurple">
                        ...
                        <Grid className="bp_hg addSpc">
                            <label dangerouslySetInnerHTML={{ __html: item.explanation }} />
                            {/* <p>Normal</p> */}
                        </Grid>

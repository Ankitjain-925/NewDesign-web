        ...
        <Grid item xs={12} md={10} className="descpCntntRght">
          <Grid className="descpInerRght descpInerBlue">
            ...
            <Grid className="bp_hg addSpc">
              <label>
                {item.rr_systolic && item.rr_systolic}/
                {item.rr_diastolic && item.rr_diastolic} <span>mmHg</span>
              </label>
              {/* <p>Normal</p> */}
            </Grid>
                  ...
                  <Grid container direction="row">
                    <Grid item xs={12} md={6} className="bloodPreBy">
                      <Grid container direction="row">
                        ...
                        <Grid item xs={7} md={7}>
                          <span>{item.rr_systolic && item.rr_systolic}</span>
                        </Grid>
                        <Grid className="clear"></Grid>
                      </Grid>
                    </Grid>
                    ...
                    <Grid item xs={12} md={6} className="bloodPreBy">
                      <Grid container direction="row">
                        ...
                        <Grid item xs={7} md={7}>
                          <span>{item.rr_diastolic && item.rr_diastolic}</span>
                        </Grid>
                        <Grid className="clear"></Grid>
                      </Grid>
                    </Grid>

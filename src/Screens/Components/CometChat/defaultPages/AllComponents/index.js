      ...
      <div className="light">
        <div style={{"display": "flex", "flexDirection": "row", "flexWrap": "wrap"}}>
          ...
          <div style={{"width": "90%", "margin": "50px","marginLeft": "auto", "marginRight": "auto", "maxWidth":"500px"}}>
            <div style={{"backgroundColor": "white", "width": "100%", "height": "100%", "boxShadow":"0px 0px 5px 0px #3335", "borderRadius": "10px", "padding": "5px"}}>
              <div style={{"textAlign": "center"}}>
                <Avatar image="https://data-us.cometchat.io/assets/images/avatars/cyclops.png"></Avatar>
                <h2>UI Unified</h2>
                <p>It open's Activity directly from UI Library. It is pre-defined UI helpful for user to build chat system by integrating it within minutes.</p>
              </div>
          ...
          <div style={{"width": "90%", "margin": "50px","marginLeft": "auto", "marginRight": "auto", "maxWidth":"500px"}}>
            <div
              ...
              <div style={{"textAlign": "center"}}>
                <Avatar image="https://data-us.cometchat.io/assets/images/avatars/cyclops.png"></Avatar>
                <h2>UI Screens</h2>
                <p>It open's Screen Activity where user can use predefined screen present in library. User can create their own layout using screen in few minutes.</p>
        ...
        <div style={{"width": "90%", "margin": "50px","marginLeft": "auto", "marginRight": "auto", "maxWidth": "maxContent"}}>
          <div onClick={this.logout} style={{"width": "100%" ,"height": "100%","display":"flex"}}>

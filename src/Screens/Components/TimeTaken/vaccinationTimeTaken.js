...
class Index extends Component {
  ...
  render() {
    ...
    switch (this.props.stateLanguageType) {
      ...
      let { addentry, profilesettings, select_time, select_date  } = translate;
    return (
      <div>
        ...
        <div>
            {index == 0 ? <div className="vaccinationAdd">
                   {!this.state.is241 && <DatePicker placeholder={select_date} name={this.props.name} onChange={(e)=>this.onDateChange(e, 0)} value={this.state.dateArr[index].value ? moment(this.state.dateArr[index].value, dateFormatList[0]) : ''}  format={dateFormatList[0]} />}
                {this.state.is241 === 'DD/MM/YYYY' && <DatePicker placeholder={select_date} name={this.props.name} onChange={(e)=>this.onDateChange(e, 0)} value={this.state.dateArr[index].value ? moment(new Date(this.state.dateArr[index].value), dateFormatList[0]) : ''}  format={dateFormatList[0]} />}
                {this.state.is241 === 'YYYY/DD/MM' && <DatePicker placeholder={select_date} name={this.props.name} onChange={(e)=>this.onDateChange(e, 0)} value={this.state.dateArr[index].value ? moment(new Date(this.state.dateArr[index].value), dateFormatList[2]) : ''}  format={dateFormatList[2]} />}
                {this.state.is241 === 'MM/DD/YYYY' && <DatePicker placeholder={select_date} name={this.props.name} onChange={(e)=>this.onDateChange(e, 0)} value={this.state.dateArr[index].value? moment(new Date(this.state.dateArr[index].value), dateFormatList[1]) : ''} format={dateFormatList[1]} />}
              ...
              : <div className="vaccinationAdd">
                {!this.state.is241 && <DatePicker placeholder={select_date} name={this.props.name} onChange={(e)=>this.onDateChange(e, 0)} value={this.state.dateArr[index].value ? moment(new Date(this.state.dateArr[index].value), dateFormatList[0]) : ''}  format={dateFormatList[0]} />}
                {this.state.is241 === 'DD/MM/YYYY' && <DatePicker placeholder={select_date} name={this.props.name} onChange={(e)=>this.onDateChange(e, index)} value={this.state.dateArr[index].value ? moment(new Date(this.state.dateArr[index].value), dateFormatList[0]) : ''}  format={dateFormatList[0]} />}
                {this.state.is241 === 'YYYY/DD/MM' && <DatePicker placeholder={select_date} name={this.props.name} onChange={(e)=>this.onDateChange(e, index)} value={this.state.dateArr[index].value ? moment(new Date(this.state.dateArr[index].value), dateFormatList[2]) : ''}  format={dateFormatList[2]} />}
                {this.state.is241 === 'MM/DD/YYYY' && <DatePicker placeholder={select_date} name={this.props.name} onChange={(e)=>this.onDateChange(e, index)} value={this.state.dateArr[index].value ? moment(new Date(this.state.dateArr[index].value), dateFormatList[1]) : ''} format={dateFormatList[1]} />}

                ...
                {index == 0 ? <div className="vaccinationAdd">
                  ...
                  : <div className="vaccinationAdd">
                    ...
                    {this.state.is24 === '24' ? <TimePicker placeholder={select_time} className="Medicationtime" onChange={(e) => { this.onTimeChange(e, index) }} value={itm.value ? moment(new Date(itm.value), 'HH:mm') : ''} format="HH:mm" /> :
                      <TimePicker placeholder={select_time} className="Medicationtime" use12Hours onChange={(e) => { this.onTimeChange(e, index) }} format="h:mm a" value={itm.value ? moment(new Date(itm.value), 'h:mm a') : ''} />}
                  </div>}

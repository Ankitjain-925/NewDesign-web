            ...
            <Grid container direction="row">
              <Grid item xs={12} sm={6} md={6}>
                <Grid className="checkHelthLbl 111">
                  ...
                  <Grid>
                    <a onClick={() => this.handleChangeEntry("blood_pressure")}>
                      {this.state.openBy !== "patient" ? (
                        <span>2</span>
                      ) : (
                        <span>1</span>
                  ...
                  <Grid className="clear"></Grid>
                  <Grid>
                    <a onClick={() => this.handleChangeEntry("condition_pain")}>
                      {this.state.openBy !== "patient" ? (
                        <span>4</span>
                      ) : (
                        <span>3</span>
                  ...
                  <Grid>
                    <a
                      onClick={() => this.handleChangeEntry("family_anamnesis")}
                    >
                      {this.state.openBy !== "patient" ? (
                        <span>10</span>
                      ) : (
              ...
              <Grid item xs={12} sm={6} md={6}>
                ...
                {this.state.openBy === "patient" &&
                  ...
                  {this.state.openBy !== "patient" && (
                    <Grid>
                      <a onClick={() => this.handleChangeEntry("prescription")}>

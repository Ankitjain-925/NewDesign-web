export function getPriceId(type) {
  ...
  if (typeof window !== "undefined") {
    ...
    env = target.match(/aidoc.io|localhost|aimedix.com|virtualhospital.aimedis.io|virtualhospital.aidoc.io/) ? "DEV" : "PRD";
  }
  if (env === "DEV") {
...
export function getPublishableKey() {
  ...
  if (typeof window !== "undefined") {
    let target = window.location.href;
    env = target.match(/aidoc.io|localhost|virtualhospital.aimedis.io|virtualhospital.aidoc.io/) ? "DEV" : "PRD";
  }

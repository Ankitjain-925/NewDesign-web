    ...
    render() {
        ...
        return (
            <div>
                ...
                {this.state.successfull && <div className="success_message">{rating_sent_success}</div>}
                    ...
                    <div className="fancyBoxMain">
                        <Modal
                            ...
                            <div className="fancyBoxCntnt">
                                ...
                                {this.state.iserr && <div className="err_message">{plz_give_rate}</div>}
                                <div className="rateStars">
                                    ...
                                    {this.state.ratings.rating >= 4 && this.state.ratings.rating < 5 && <p>{very_good}</p>}
                                ...
                                <div className="shrtMsg">
                                    ...
                                    {this.state.EditRating ? <div><input type="submit" onClick={this.handleCloseFancy} value="Ok and Close" /></div> : <div><input type="submit" onClick={this.SendRating} value={save_and_cont} /></div>}
                                </div>
                            </div>
                        </Modal>
                    </div>

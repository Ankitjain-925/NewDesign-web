                            ...
                            <Grid className="row">
                                <Grid className="col-xl-6">
                                    ...
                                    <Grid>
                                        ...
                                        <label><img src={require('../../../assets/images/Chinese.png')} alt="Chinese" title="Chinese" />Chinese (中文)</label>
                                    </Grid>
                                    <Grid>
                                        <input value="nl" onChange={this.changeLanguage} name="language" type="radio" checked={this.state.languageValue == "nl" ? "checked" : ""} />
                                        <label><img src={require('../../../assets/images/Dutch.jpg')} alt="Dutch" title="Dutch" />Dutch (Nederlands)</label>
                                    </Grid>
                                    <Grid>
                                ...
                                <Grid className="col-xl-6">
                                    ...
                                    <Grid>
                                        ...
                                        <label><img src={require('../../../assets/images/Portugal.png')} alt="Portuguese" title="Portuguese" />Portuguese (Portugués)</label>
                                    </Grid>
                                    <Grid>
                                        <input value="rs" onChange={this.changeLanguage} name="language" type="radio" checked={this.state.languageValue == "rs" ? "checked" : ""} />
                                        <label><img src={require('../../../assets/images/Russian.jpg')} alt="Russian" title="Russian" />Russian (русский)</label>
                                    </Grid>
                                    <Grid>
                                        <input value="sp" onChange={this.changeLanguage} name="language" type="radio" checked={this.state.languageValue == "sp" ? "checked" : ""} />
                                        <label><img src={require('../../../assets/images/Spanish.png')} alt="Spanish" title="Spanish" />Spanish (Español)</label>
                                    </Grid>
                                    <Grid>
                                        <input value="sw" onChange={this.changeLanguage} name="language" type="radio" checked={this.state.languageValue == "sw" ? "checked" : ""} />
                                        <label><img src={require('../../../assets/images/Swahili.jpg')} alt="Swahili" title="Swahili" />Swahili (Kiswahili)</label>
                                    </Grid>
                                </Grid>

                            ...
                            <Grid item xs={11} md={11}>
                                <Grid className="cmnLftSpc ptntFlowSpc">
                                    <Grid className="addFlow">
                                        <Grid container direction="row" justify="center">
                                            <Grid item xs={12} sm={6} md={6}><h1>Patient Flow</h1></Grid>
                                        ...
                                        <Grid container direction="row" justify="center">
                                            ...
                                            <Grid item xs={12} md={7}>
                                                <Grid className="srchRght">
                                                    <a className="srchSort"><img src={require('assets/virtual_images/sort.png')} alt="" title="" /></a>
                                                    <Select
                                                        ...
                                                        isSearchable={false}
                                                    />
                                                    <a className="lineSort" onClick={(()=>{this.setState({view: 'vertical'})})}><img src={require('assets/virtual_images/lines.png')} alt="" title="" /></a>
                                                    <a className="horzSort" onClick={(()=>{this.setState({view: 'horizontal'})})}><img src={require('assets/virtual_images/timeline-view-active.svg')} alt="" title="" /></a>
                                                </Grid>
                                            </Grid>
                                        </Grid>
                                        </Grid>

...
export default class Column extends Component {
  ...
  handleOutsideClick = (event) => {
    if (
      ...
      this?.list &&
      !this.list?.current?.contains(event.target)
    ) {
          ...
          {(provided, snapshot) => (
            ...
            >
                          ...
                          <ul>
                            {!this.state.inneerSec && (
                              <Grid>
                                ...
                                <li>
                                  <a
                                    onClick={() => {
                                      this.setState({ inneerSec: 'move_all' });
                                    }}
                                  >
                            ...
                            {this.state.inneerSec === 'step_move' && (
                              <div>
                                ...
                                <Grid className="positionDrop">
                                  {this.props.ordered?.length > 0 &&
                                    this.props.ordered.map((item, index1) => (
                                      <Grid>
                                        <label
                                          onClick={() => {
                                            this.props.moveStep(
              ...
              <QuoteList
                ...
                listType="QUOTE"
                style={{
                  backgroundColor: snapshot.isDragging ? '#00abaf' : null,
                }}

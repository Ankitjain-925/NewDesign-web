...
class Index extends Component {
  ...
  GetLanguageMetadata = () => {
    ...
    this.setState({
      ...
      bloodgroup:
        this.state.allMetadata &&
        this.state.allMetadata.bloodgroup &&
        this.state.allMetadata.bloodgroup.length > 0 &&
        this.state.allMetadata.bloodgroup,
        ...
        if (
          ...
          if (UpDataDetails.birthday && UpDataDetails.birthday !== '') {
            if (UpDataDetails?.mobile?.split('-')?.[0]) {
              var country_code = UpDataDetails?.mobile
                ?.split('-')?.[0]
                .toLowerCase();
            } else {
              var country_code = 'de';
            ...
            var parent_id = this.props.stateLoginValueAim?.user?.parent_id
              ? this.props.stateLoginValueAim?.user?.parent_id
              : '0';
  ...
  render() {
    ...
    let {
      create_new_user,
      Patient_does_not_have_email_the_email_created_by_Hospital,
      Citizenship,
      created_user_id_and_pin,
      Register_characters,
                      ...
                      <div>
                          ...
                          <Grid className="editBoxCntnt">
                            ...
                            <Grid className="editPinform">
                              <Grid className="editField">
                                <h5>
                                  {AliesID} {this.state.idpin?.profile_id}
                                </h5>
                                <h5>
                                  {Pin}
                                  {this.state.idpin?.pin}
                                </h5>
                              </Grid>
                            </Grid>
                          </Grid>
                        ...
                        <Grid container direction="row" alignItems="center">
                          <Grid item xs={12} md={8}>
                            <div className="err_message">
                              ...
                              {this.state.alreadyerrorInfo &&
                                'User already exists with given Information'}
                            </div>
                            <Grid className="profileInfo">
                                  ...
                                  <Grid item xs={8} md={8}>
                                    ...
                                    <Grid>
                                      <input
                                        ...
                                        value={
                                          this.state.UpDataDetails.email || ''
                                        }
                                      />
                                    </Grid>
                                  </Grid>
                                  ...
                                  <div className="passInst">
                                    <div className="passInstIner">
                                      ...
                                      <ul>
                                        ...
                                        <li>
                                          {this.state.UpDataDetails?.password &&
                                            !this.state.UpDataDetails?.password.match(
                                              letter
                                            ) && (
                                              <a>
                                                <img
                                ...
                                >
                                  ...
                                  <Grid item xs={12} md={8}>
                                    ...
                                    <Grid>
                                      ...
                                      <a
                                        onClick={() =>
                                          this.EntryValueName('female', 'sex')
                                        }
                                        className={
                                          this.state.UpDataDetails.sex &&
                                          this.state.UpDataDetails.sex ===
                                  ...
                                  <Grid item xs={12} md={8}>
                                    ...
                                    <Grid>
                                      <Autocomplete
                                        ...
                                        onPlaceChanged={this.updateEntryCity.bind(
                                          this
                                        )}
                                      />
                                    </Grid>
                                ...
                                >
                                  <Grid item xs={12} md={8}>
                                    ...
                                    <Grid className="cntryDropTop">
                                      <Select
                                        value={
                                          this.state.UpDataDetails.country || ''
                                        }
                                        onChange={(e) =>
                                  ...
                                  <Grid item xs={12} md={4}>
                                    ...
                                    <Grid>
                                      <Select
                                        ...
                                        name="bloodgroup"
                                        onChange={(e) => {
                                          this.onSelectBlood(e, 'bloodgroup');
                                        }}
                          ...
                          <Grid className="emrgncyFrmInpt">
                            ...
                            <Grid>
                              <input
                                ...
                                onChange={this.contact_partnerState}
                              />
                            </Grid>
                          </Grid>
                          <Grid className="emrgncyFrmInpt">
                                ...
                                this.updateFLAG(
                                  ...
                                  <ReactFlagsSelect
                                    ...
                                    onSelect={(e) => {
                                      this.updateFlags(
                                        e,
                                        'flag_emergency_number'
                                      );
                                    }}
                                    name="flag_emergency_number"
                                    showSelectedLabel={false}
                                    defaultCountry={this.updateFLAG(
                                      this.state.contact_partner.number
                                    )}
                        ...
                        <Grid className="insrnceTbl">
                          ...
                          <Grid className="profileIdRght">
                            <a onClick={this.handleAddInsurance}>
                              {Addcompany}
                            </a>
                          </Grid>

              ...
              <td valign="top">
                ...
                <table width="100%" className="TblPG2 secsttabhead">
                  ...
                  <tr>
                    <td>
                      <strong>
                        {this.props?.House?.label && this.props?.House.label}
                      </strong>
                    </td>
                    <td>
                      <strong>
                    ...
                    {data?.services &&
                      ...
                      data?.services.map((item) => (
                        <tr>
                          ...
                          <th width="8%" className="tabAligPro">
                            {item?.price}
                          </th>
                        </tr>
                      ))}
...
export default withRouter(
  connect(mapStateToProps, { LoginReducerAim, houseSelect, Settings })(Index)
);

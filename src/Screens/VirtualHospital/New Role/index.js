...
class Index extends Component {
  ...
  componentDidUpdate = (prevProps) => {
    if (
      prevProps.openHouse1 !== this.props.openHouse1 ||
      prevProps.weoffer !== this.props.data ||
      prevProps.heading !== this.props.label ||
                        ...
                        <>
                          <span>
                            <Checkbox
                              name={item.label}
                              value={item.value}
                              checked={this.state.demo.options == true}
                              onChange={(e) => this.handleChange(e)}
                            />
                          </span>
                          {item.label}{' '}
                          <span className="hosFstSec">
                            <ExpandMoreIcon />
                          </span>
                        </>
                      }
                          ...
                          <FormControlLabel
                            control={
                              <Checkbox
                                ...
                                checked={
                                  this.state.newTsk.options
                                    ? this.state.newTsk.options
                                    : null
                                }
                                onChange={(e) => this.handleweoffer(e, index)}
                              />
                            }
                            label={item2.label}
                          />

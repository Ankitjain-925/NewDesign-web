                                    ...
                                    <Grid item xs={12} md={9}>
                                        <Grid className="chatclient">
                                            ...
                                            <Grid className="chatMessages">
                                                ...
                                                <Grid className="chatSendUpr">
                                                    <Grid className="chatSend">
                                                        <p>How about 1pm?</p>
                                                    </Grid>
                                                </Grid>

                                                <Grid className="chatRplyUpr">
                                                    <Grid className="chatRply">
                                                        <p>That's sounds awesome! Want to check out that new cafe down the street from the park?</p>
                                                    </Grid>
                                                    <Grid><span>07:56 PM</span></Grid>
                                                </Grid>

                                                <Grid className="chatSendUpr">
                                                    <Grid className="chatSend">
                                                        <p>Perfect! I've been waiting to go. I hear the pizza is delicious 😋</p>
                                                    </Grid>
                                                    <Grid><span>08:56 PM</span></Grid>
                                                </Grid>

                                                <Grid className="chatRplyUpr">
                                                    <Grid className="chatRply">
                                                        <p>Excelent! See you Saturday at 1pm in front of the cafe.</p>
                                                    </Grid>
                                                    <Grid><span>09:56 PM</span></Grid>
                                                </Grid>

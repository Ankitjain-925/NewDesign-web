...
class Index extends Component {
  ...
  render() {
    ...
    let { InstituteGroups, EditGroup, Delete, Hospitals, AddInstituteGroup, AddInstitution, UploadInstitutionLogo,
      CurrentLogo, save_and_close, hosp_name, DescriptionNote, EditHospital, EnterHospitals, AddHospital, Enterhospitalname, Enterinstitutiondescriptionnote, Enterhospitaldescriptionnote, Save, Enterinstitutegroupname, UploadHospitalLogo } = translate;
    return (
      <Grid
        className={
          this.props.settings &&

...
export const GET_LANGUAGE_TYPE = "get_language_type";
export const GET_LANGUAGE_TYPE_FAIL = "get_language_type_fail";
...
export const GET_EMERGENCY_FAIL = "get_emergency_fail";
